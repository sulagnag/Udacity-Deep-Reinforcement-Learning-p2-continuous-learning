...
def linear_layers(nS,hidden_dim1,hidden_dim2,l2_input,l3_out):
    ...
    layer2 = nn.Linear(l2_input,hidden_dim2)
...
class Actor(nn.Module):
    """Actor (Policy) Model."""
    def __init__(self,nS,nA,seed,hidden_dim1=330,hidden_dim2=300):
        super(Actor, self).__init__()
               
        self.fc1, self.fc2, self.fc3 = linear_layers(nS,hidden_dim1,hidden_dim2,hidden_dim1,nA)
...
class Critic(nn.Module):
    ...
    def __init__(self,nS,nA,seed,hidden_dim1=330,hidden_dim2=300):
        ...
        self.fc1, self.fc2, self.fc3 = linear_layers(nS,hidden_dim1,hidden_dim2,hidden_dim1+nA,1)
